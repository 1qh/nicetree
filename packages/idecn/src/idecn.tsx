...
/* oxlint-disable promise/prefer-await-to-then, promise/always-return, no-react-children, react-perf/jsx-no-new-object-as-prop, unicorn/prefer-top-level-await, jsx-a11y/no-static-element-interactions, jsx-a11y/click-events-have-key-events, no-img-element */
'use client'
